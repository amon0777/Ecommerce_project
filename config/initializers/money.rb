...
MoneyRails.configure do |config|
  ...
  # Set the default currency to USD (or your preferred currency like CAD)
Money.default_currency = Money::Currency.new("CAD")

# Use recommended i18n formatting instead of deprecated legacy behavior
Money.locale_backend = :i18n

# Optional: Set default rounding mode
